...
const styles = StyleSheet.create({
  ...
  toolbar: { flexDirection: 'row', flexWrap: 'wrap', backgroundColor: '#fff', borderRadius: 16, borderWidth: 1, borderColor: '#dbe6ee', padding: 14, marginBottom: 18, gap: 12, alignItems: 'center' },
  searchInput: { flexGrow: 1, flexShrink: 1, flexBasis: 260, minHeight: 46, borderWidth: 1, borderColor: '#b8d8ee', borderRadius: 13, paddingHorizontal: 13, color: '#1e293b', backgroundColor: '#fff', fontSize: 15 },
  filters: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  filterChip: { minWidth: 90, borderWidth: 1, borderColor: '#b8d8ee', borderRadius: 18, paddingHorizontal: 13, paddingVertical: 9, backgroundColor: '#fff', alignItems: 'center' },
  filterChipActive: { backgroundColor: '#0077CC', borderColor: '#0077CC' },
  filterText: { color: '#0077CC', fontWeight: 'bold', fontSize: 13 },
  filterTextActive: { color: '#fff' },
  loader: { marginTop: 28 },
  grid: { flexDirection: 'row', flexWrap: 'wrap', gap: 16, paddingVertical: 4 },
  card: { flexGrow: 1, flexShrink: 1, flexBasis: 300, maxWidth: '100%', backgroundColor: '#fff', borderRadius: 18, borderWidth: 1, borderColor: '#dbe6ee', padding: 18, shadowColor: '#0077CC', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.08, shadowRadius: 12, elevation: 2 },
  ...
  cardFooter: { borderTopWidth: 1, borderTopColor: '#e7eef3', marginTop: 17, paddingTop: 12, flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 8 },
